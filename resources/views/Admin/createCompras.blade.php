...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Register Compras') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('create') }}">
                        ...
                        <div class="form-group row">
                            <label for="quanty" class="col-md-4 col-form-label text-md-right">{{ __('Quanty') }}</label>

                            <div class="col-md-6">
                                <input id="quanty" type="text" class="form-control @error('quanty') is-invalid @enderror" name="quanty" required autocomplete="new-quanty">
